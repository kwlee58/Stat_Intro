...
birthday %>% str
names(birthday) <- c("dept", "id", "name", "year", "e.mail", "cell.no", "Q1", "Q2", "group")
birthday$dept %<>% factor
birthday$year %<>% factor
birthday$group %<>% factor(levels = c("Red", "Black"))

##> 생일이 같은 사람을 찾아 날짜 순으로 늘어세우기.
##1> 입력된 데이터 살피기
#> strsplit(birthday$Q2, ",") 하면 나오는 리스트의 요소를 month와 date 로 나웠다 다시 합치기
#> Q2의 생김새
birthday$Q2
#> pipe를 이용하여 고쳐쓰면
##> select를 이용할 때
...
`r knitr::include_graphics("../pics/birthday_Q1.png", dpi = NA)`
