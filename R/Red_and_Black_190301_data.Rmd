...
class_roll0224 <- class_roll
str(class_roll0224)
class_roll0224 <- class_roll0224[, -8]
nrow(class_roll0224)
class_roll <- read.xlsx("../data/class_roll_intro190301.xlsx", 
                        sheetIndex = 1, 
                        startRow = 2, 
                        endRow = 82, 
                        colIndex = c(3:7, 9), 
...
class_roll0224$mark1 <- "0224"
class_roll$mark2 <- "0301"
class_roll.merged <- merge(class_roll, class_roll0224, 
                                by = "id", 
                                all = TRUE)
```
...
```{r, echo = FALSE, results = "hide"}
id0224 <- class_roll0224$id
id0301 <- class_roll$id
stay0301 <- intersect(id0301, id0224)
length(stay0301)
new_id <- setdiff(id0301, id0224)
class_roll.stay <- subset(class_roll0224, id %in% stay0301)
...
class_roll %>%
  `[`(.$id %>% order, c("id", "group")) %>%
  saveRDS(file = "./class_id_group190301.RDS")
save.image("./red_and_black_intro_190301_data.RData")
```
-->