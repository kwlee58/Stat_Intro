...
axis(side = 2,
     ...
     labels = format(c(0, apply(t(Nature1_p), MARGIN = 2, cumsum)), 
                     digits = 3, nsmall = 1), 
     las = 2)
# y_text <- c(t(Nature1_p)[1, ] / 2, 
#             t(Nature1_p)[1, ]  + t(Nature1_p)[2, ] / 2, 
#             t(Nature1_p)[1, ]  + t(Nature1_p)[2, ] + t(Nature1_p)[3, ] / 2)
y_text <- c(apply(t(Nature1_p), MARGIN = 2, function(x) cumsum(x) - x / 2))
text(rep(b1, each = 3), y_text, labels = c(t(Nature1)))
legend("topright", fill = cols[3:1], legend = rev(colnames(Nature1)))
...
axis(side = 2,
     ...
     labels = format(c(0, apply(t(Nature2_p), MARGIN = 2, cumsum)), 
                     digits = 3, nsmall = 1), 
     las = 2)
# y_text2 <- c(t(Nature2_p)[1, ] / 2, 
#             t(Nature2_p)[1, ]  + t(Nature2_p)[2, ] / 2)
y_text2 <- c(apply(t(Nature2_p), MARGIN = 2, function(x) cumsum(x) - x / 2))
text(rep(b2, each = 2), y_text2, labels = c(t(Nature2)))
...
axis(side = 2,
     ...
     labels = format(c(0, apply(t(Nature3_p), MARGIN = 2, cumsum)), 
                     digits = 3, nsmall = 1), 
     las = 2)
# y_text3 <- c(t(Nature3_p)[1, ] / 2, 
#              t(Nature3_p)[1, ]  + t(Nature3_p)[2, ] / 2)
y_text3 <- c(apply(t(Nature3_p), MARGIN = 2, function(x) cumsum(x) - x / 2))
text(rep(b3, each = 2), y_text3, labels = c(t(Nature3)))
legend("top", fill = cols[2:1], legend = rev(colnames(Nature2)))
...
axis(side = 2,
     at = c(0, apply(t(DollnHill_p), MARGIN = 2, cumsum)),
     labels = format(c(0, apply(t(DollnHill_p), MARGIN = 2, cumsum)), 
                     digits = 2, nsmall = 1), las = 2)
...
y_text4 <- c(apply(t(DollnHill_p), MARGIN = 2, function(x) cumsum(x) - x / 2))
text(rep(b4, each = 5), y_text4, labels = c(t(DollnHill)))
...
y_text5 <- c(apply(t(DollnHill2_p), MARGIN = 2, function(x) cumsum(x) - x / 2))
text(rep(b5, each = 5), y_text5, labels = paste0(format(c(t(DollnHill2_p)), digits = 3, nsmall = 1), "%"))
