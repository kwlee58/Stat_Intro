...
```{r, ggmap, echo = FALSE, fig.width = 10.5, fig.height = 10.5}
...
```{r, snow, echo = FALSE, fig.width = 10.5, fig.height = 10.5}
snow <- ggmap(m) +
  geom_point(data = as.data.frame(cholera_latlong),
             aes(x = coords.x1,
                 y = coords.x2,
...
```{r, Pumps, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10.5, fig.height = 10.5}
# pumps <- readOGR(dsn, 
#                  layer = "Pumps")
# proj4string(pumps) <- CRS("+init=epsg:27700")
# pumps_latlong <- pumps %>% 
