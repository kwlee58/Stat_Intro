...
nrow(class_roll0301)
class_roll <- read.xlsx("../data/class_roll_intro190305.xlsx", 
                        sheetIndex = 1, 
                        startRow = 2, 
                        endRow = 82, 
                        colIndex = c(3:7, 9), 
...
stay0305 <- intersect(id0305, id0301)
length(stay0305)
new_id <- setdiff(id0305, id0301)
class_roll.stay <- subset(class_roll0301, id %in% stay0305)
...
class_roll %>%
  `[`(.$id %>% order, c("id", "group")) %>%
  saveRDS(file = "./class_id_group190305.RDS")
save.image("./red_and_black_190305_data.RData")
```
-->